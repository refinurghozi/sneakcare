<?php
 ...
 <head>
     ...
     <!-- Morris Charts CSS -->
     <link href="<?php echo base_url('asseta/vendor/morrisjs/morris.css')?>" rel="stylesheet">
 ...
 <body>
             ...
             <div class="navbar-default sidebar" role="navigation">
                 <div class="sidebar-nav navbar-collapse">
                     <ul class="nav" id="side-menu">
                         ...
                         <li>
                             <a href="<?php echo base_url('Cform/readData')?>"><i class="fa fa-table fa-fw"></i> Tables</a>
                         </li>
     ...
     <script src="<?php echo base_url('asseta/vendor/raphael/raphael.min.js')?>"></script>
     <script src="<?php echo base_url('asseta/vendor/morrisjs/morris.min.js')?>"></script>
     <script src="<?php echo base_url('asseta/data/morris-data.js')?>"></script>
