    ...
    <section class="bg-primary text-white mb-0" id="about">
      <div class="container">
        ...
        <div class="text-center mt-4">
          ...
          <form action="add.php" method="post" name="form"> <!--class="text-center text-uppercase text-white"-->
        		<table width="25%" border="0">
        			...
        			<tr>
        				<td>Alamat</td> <!--mau pake googlemaps-->
        				<td>
                  ...
                  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBy3YBHJfScaD7SD3wwc2bMB9FSK4KndEw&libraries=places&callback=initAutocomplete"
                       async defer></script>
        			...
        			<tr>
        				<td>Jumlah Sepatu</td> <!--mau pake ticker-->
        				<td><input type="number" name="komentar"></td>
        			</tr>
              <tr>
        				<td>Jenis Service</td> <!--mau pake dropdown-->
        				<td>
                  <select>
